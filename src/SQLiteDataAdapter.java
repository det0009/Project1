...
public class SQLiteDataAdapter implements IDataAdapter {
      ...
      //  PurchaseModel res = new PurchaseModel();
        ...
        try {
           // String sql = "SELECT * FROM Purchases WHERE Purchaseid = " + purchaseID;
            String sql = "SELECT PurchaseID, CustomerID, ProductID, Price, Cost, TaxRate, TotalCost, Date FROM Purchases WHERE PurchaseID = " + purchaseID;
    ...
    public int savePurchase(PurchaseModel purchase) {
        try {
            ...
            if (p != null) {
                stmt.executeUpdate("DELETE FROM Products WHERE PurchaseID = " + purchase.mPurchaseID);
            }

            String sql = "SELECT PurchaseID, CustomerID, ProductID, Price, Cost, TaxRate, TotalCost, Date FROM Purchases WHERE PurchaseID = " + purchase;
            System.out.println(sql);
